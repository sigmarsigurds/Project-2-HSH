...
class InventoryRepository:
    ...
    def get_product(self, product_id: int, merchant_id: int = None) -> Optional[ProductModel]:
    ...
    def reserve_product(self, product_id: int, quantity_to_reserve: int) -> Optional[ProductModel]:
        """
