...
class MerchantDoesNotExistException(Exception):
    pass


class MerchantExistsValidation(Validation):
    def __init__(self, merchant_id) -> None:
        self.__request_url: str = "http://merchant-service-api:8001/merchants/"
        self.__merchant_id: int = merchant_id
    ...
    def validate(self) -> bool:
        ...
        if not valid:
            ...
            # raise MerchantDoesNotExistException(self.__fail_message)
        return True
